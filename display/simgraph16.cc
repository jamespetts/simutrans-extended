...
void display_veh_form_wh_clip_rgb(KOORD_VAL xp, KOORD_VAL yp, KOORD_VAL w, KOORD_VAL h, PIXVAL color, bool dirty, bool is_rightside, uint8 basic_constraint_flags, uint8 interactivity  CLIP_NUM_DEF_NOUSE)
{
	if (h > 1 && h % 2 == 0) { h--; }
