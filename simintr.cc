...
char const *tick_to_string( sint64 ticks, bool show_full )
{
	...
	else if (env_t::show_month == env_t::DATE_FMT_INTERNAL_MINUTE || env_t::show_month == env_t::DATE_FMT_JAPANESE_INTERNAL_MINUTE || env_t::show_month == env_t::DATE_FMT_64_SECOND_MINUTE) {
