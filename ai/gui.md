...
- Widely-included headers: `simwin.h`, `gui_frame.h`, `components/gui_label.h`, `components/gui_button.h`, `components/action_listener.h` [CODE].
...
- Known-fragile areas (root artefact: "ex-15-failed-attempt-at-fixing-co-gui" branch as a historical indication).
