...
- The root holds many untracked/ignored entries: `*.obj`, `*.diagsession`, `*.psess/*.vsp`, `Debug*/ Release*/ x64/ intermediates/`, `.vs/`, `*.VC.db`, `base_texts*.dat` (ignored translation fragments), `wishlist.txt` (ignored) [CODE + .gitignore].
